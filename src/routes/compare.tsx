...
export const Route = createFileRoute("/compare")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://travellinks.uk/__l5e/assets-v1/2672f8ec-8974-4080-8be8-547d8161e57c/why-us-plane.png" },
      { property: "og:image:alt", content: "Compare visas & countries — Travel Links Solution" },
      { name: "twitter:image", content: "https://travellinks.uk/__l5e/assets-v1/2672f8ec-8974-4080-8be8-547d8161e57c/why-us-plane.png" },
            ...
            <div className="flex items-end justify-between gap-4 flex-wrap">
              <div>
                ...
                <p className="mt-2 max-w-2xl text-sm text-muted-foreground">
                  The questions we get asked most. Open a country page for full details, or load a preset back into the table above.
                </p>
              </div>
              <Link
                to="/countries"
