...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://travellinks.uk/__l5e/assets-v1/b1cbf8b8-3b40-45e1-9edf-858e83362275/about-visa.png" },
      { property: "og:image:alt", content: "Contact Travel Links Solution — Northampton visa consultants" },
      { name: "twitter:image", content: "https://travellinks.uk/__l5e/assets-v1/b1cbf8b8-3b40-45e1-9edf-858e83362275/about-visa.png" },
